...
clefs_r1=['nom','BOS/DET', 'PIT/CLB', 'TB/MTL', 'NYR/PHI', 'ANA/DAL', 'COL/MIN', 'SJ/LA', 'STL/CHI']
r1=[]
r1.append(['Travis*', 'BOS 6', 'PIT 6', 'MTL 6', 'NYR 7', 'ANA 6', 'COL 6', 'SJ 7', 'CHI 6', 'BOS'])
r1.append(['Blaise*', 'BOS 7', 'PIT 7', 'MTL 7', 'NYR 7', 'ANA 7', 'MIN 7', 'LA 7', 'CHI 7', 'BOS'])
r1.append(['Nath*', 'BOS 5', 'PIT 6', 'MTL 6', 'PHI 7', 'ANA 5', 'COL 6', 'LA 7', 'CHI 6', 'ANA'])
r1.append(['Daf*', 'BOS 5', 'PIT 5', 'MTL 6', 'NYR 6', 'ANA 4', 'COL 5', 'LA 7', 'STL 7', 'BOS'])
r1.append(['Normand', 'BOS 6', 'PIT 7', 'MTL 6', 'NYR 6', 'ANA 5', 'COL 6', 'LA 7', 'CHI 6', 'ANA'])
r1.append(['Lam*', 'BOS 7', 'CLB 7', 'MTL 6', 'NYR 6', 'DAL 5', 'COL 6', 'LA 7', 'STL 7', 'MTL'])
r1.append(['Daniel*', 'BOS 6', 'PIT 5', 'MTL 6', 'NYR 7', 'ANA 5', 'COL 6', 'LA 6', 'CHI 6', 'PIT'])
r1.append(['Seb*', 'BOS 5', 'PIT 6', 'MTL 6', 'NYR 7', 'ANA 5', 'COL 7', 'LA 6', 'CHI 6', 'BOS'])
r1.append(['Alain B.*', 'BOS 6', 'PIT 6', 'MTL 6', 'NYR 6', 'ANA 6', 'COL 6', 'LA 6', 'CHI 6', 'BOS'])
r1.append(['Michel*', 'BOS 5', 'PIT 5', 'TB 7', 'PHI 7', 'ANA 4', 'COL 6', 'SJ 5', 'CHI 5', 'ANA'])
r1.append(['Patrick', 'BOS 7', 'PIT 6', 'MTL 6', 'NYR 6', 'ANA 6', 'COL 5', 'LA 6', 'CHI 7', 'ANA'])
r1.append(['Dominique*', 'BOS 5', 'PIT 7', 'MTL 6', 'NYR 6', 'ANA 6', 'COL 5', 'SJ 7', 'CHI 6', 'BOS'])
r1.append(['Phil*', 'BOS 6', 'PIT 6', 'MTL 6', 'PHI 6', 'ANA 4', 'COL 5', 'SJ 6', 'STL 6', 'BOS'])
r1.append(['Eric', 'BOS 5', 'PIT 7', 'TB 5', 'NYR 7', 'ANA 5', 'MIN 6', 'LA 7', 'CHI 5', 'BOS'])
r1.append(['Simon', 'BOS 5', 'PIT 6', 'TB 5', 'PHI 7', 'ANA 5', 'COL 5', 'LA 6', 'CHI 6', 'BOS'])
r1.append(['Jacinthe*', 'BOS 6', 'PIT 5', 'MTL 6', 'NYR 7', 'ANA 5', 'COL 7', 'SJ 7', 'CHI 7', 'PIT'])
r1.append(['Valerie*', 'BOS 6', 'PIT 5', 'MTL 6', 'PHI 7', 'ANA 5', 'COL 5', 'LA 7', 'CHI 6', 'ANA'])
r1.append(['Dominic*', 'BOS 5', 'PIT 6', 'MTL 6', 'NYR 5', 'ANA 6', 'COL 6', 'SJ 6', 'CHI 6', 'BOS'])
r1.append(['Leon (hors concours)*', 'BOS 6', 'PIT 7', 'MTL 4', 'PHI 6', 'DAL 7', 'MIN 7', 'SJ 5', 'CHI 5', 'MTL'])
...
clefs_r2=['nom', 'BOS/MTL', 'PIT/NYR', 'ANA/LA', 'CHI/MIN']
r2=[]
r2.append(['Travis*', 'MTL 6', 'NYR 7', 'LA 6', 'CHI 6'])
r2.append(['Blaise*', 'BOS 7', 'NYR 7', 'ANA 7', 'CHI 7'])
r2.append(['Nath*', 'BOS 6', 'PIT 7', 'ANA 6', 'CHI 5'])
r2.append(['Daf', 'MTL 6', 'NYR 6', 'LA 6', 'MIN 6'])
r2.append(['Normand', 'MTL 7', 'PIT 6', 'ANA 7', 'CHI 5'])
r2.append(['Lam*', 'MTL 5', 'NYR 6', 'LA 6', 'CHI 7'])
r2.append(['Daniel', 'MTL 6', 'PIT 6', 'LA 6', 'CHI 5'])
r2.append(['Seb*', 'MTL 6', 'NYR 6', 'ANA 5', 'CHI 6'])
r2.append(['Alain B.*', 'BOS 6', 'PIT 6', 'LA 6', 'CHI 6'])
r2.append(['Michel*', 'BOS 7', 'NYR 6', 'ANA 7', 'CHI 5'])
r2.append(['Patrick', 'MTL 6', 'NYR 7', 'ANA 7', 'CHI 5'])
r2.append(['Dominique*', 'BOS 6', 'PIT 7', 'ANA 6', 'CHI 7'])
r2.append(['Phil*', 'MTL 6', 'PIT 6', 'ANA 7', 'CHI 5'])
r2.append(['Eric', 'BOS 4', 'PIT 6', 'LA 6', 'CHI 5'])
r2.append(['Simon', 'BOS 6', 'NYR 5', 'ANA 7', 'CHI 6'])
r2.append(['Jacinthe*', 'MTL 6', 'PIT 7', 'LA 6', 'CHI 6'])
r2.append(['Valerie*', 'MTL 7', 'PIT 7', 'ANA 6', 'CHI 6'])
r2.append(['Dominic*', 'BOS 6', 'PIT 7', 'LA 7', 'CHI 7'])
r2.append(['Leon (hors concours)*', 'MTL 7', 'PIT 7', 'ANA 7', 'CHI 6'])

clefs_r3=['nom', 'MTL/NYR', 'CHI/LA']
r3=[]
r3.append(['Travis*', 'MTL 6', 'LA 7'])
r3.append(['Blaise*', 'MTL 5', 'CHI 5'])
r3.append(['Nath*', 'MTL 6', 'CHI 7'])
r3.append(['Daf', 'MTL 6', 'LA 7'])
r3.append(['Normand', 'MTL 6', 'CHI 6'])
r3.append(['Lam*', 'MTL 6', 'LA 7'])
r3.append(['Daniel', 'MTL 5', 'LA 7'])
r3.append(['Seb*', 'MTL 6', 'CHI 6'])
r3.append(['Alain B.*', 'MTL 6', 'CHI 6'])
r3.append(['Michel*', 'MTL 7', 'CHI 7'])
r3.append(['Patrick', 'MTL 6', 'CHI 7'])
r3.append(['Dominique*', 'MTL 6', 'CHI 6'])
r3.append(['Phil*', 'MTL 6', 'LA 6'])
r3.append(['Eric', 'NYR 6', 'CHI 5'])
r3.append(['Simon', 'NYR 5', 'LA 6'])
r3.append(['Jacinthe*', 'MTL 7', 'CHI 6'])
r3.append(['Valerie*', 'MTL 7', 'CHI 7'])
r3.append(['Dominic*', 'MTL 6', 'CHI 7'])
r3.append(['Leon (hors concours)*', 'MTL 6', 'CHI 6'])

clefs_r4=['nom', 'LA/NYR']
r4=[]
r4.append(['Travis*', 'LA 6'])
r4.append(['Blaise*', 'NYR 7'])
r4.append(['Nath*', 'NYR 6'])
r4.append(['Daf', 'LA 5'])
r4.append(['Normand', 'LA 5'])
r4.append(['Lam*', 'LA 4'])
r4.append(['Daniel', 'NYR 6'])
r4.append(['Seb*', 'NYR 7'])
r4.append(['Alain B.*', 'NYR 6'])
r4.append(['Michel*', 'LA 7']) 
r4.append(['Patrick', 'LA 5'])
r4.append(['Dominique*', 'LA 6'])
r4.append(['Phil*', 'NYR 4'])
r4.append(['Eric', 'NYR 6'])
r4.append(['Simon', 'LA 5'])
r4.append(['Jacinthe*', 'LA 5'])
r4.append(['Valerie*', 'LA 6']) 
r4.append(['Dominic*', 'NYR 7'])
r4.append(['Leon (hors concours)*', 'LA 5'])



res_r1={'TB/MTL' : 'MTL 4', 'BOS/DET' : 'BOS 5', 'STL/CHI' : 'CHI 6', 'ANA/DAL':'ANA 6', 'NYR/PHI':'NYR 7', 'COL/MIN': 'MIN 7', 'SJ/LA': 'LA 7', 'PIT/CLB':'PIT 6'}
res_r2={'PIT/NYR' : 'NYR 7', 'CHI/MIN' : 'CHI 6', 'BOS/MTL' : 'MTL 7', 'ANA/LA' : 'LA 7'}
res_r3={'MTL/NYR' : 'NYR 6', 'CHI/LA' : 'LA 7'}
res_r4={'LA/NYR' : 'LA 5'}
...
for i,p in enumerate(choix) :
    ...
    #						pts[ronde-1]=pts[ronde-1]+pts_matchs[ronde-1]
				...
				if listeCs[i][-1] == res_g :
				    pts[4] = 10*ronde
				    print "*** pts pour Coup de circuit ***", ronde, pts[ronde]
...
page_choix=SimpleDocument('zp2014rc.html')
...
texte.append(coupe)
texte.append(Font('Ze Pool 2014',color=HTMLcolors.RED,size='+2'))
texte.append(coupe)
...
##################################################
# page des resultats
page_res=SimpleDocument('zp2014rc.html')
#ligne horizontale
page_res.append(HR())
...
##################################################
# page du classement
page_classement=SimpleDocument('zp2014rc.html')
#ligne horizontale
...
page_r1=SimpleDocument('zp2014rc.html')
#ligne horizontale
page_r1.append(HR())
# ancre de cette partie et ajout du lien
...
##################################################
# reglements
page_regle=SimpleDocument('zp2014rc.html')
#ligne horizontale
