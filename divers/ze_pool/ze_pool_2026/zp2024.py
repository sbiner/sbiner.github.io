...
page_choix=SimpleDocument('zp2024rc.html')
...
texte.append(coupe)
texte.append(Font('Ze Pool 2024',color=HTMLcolors.RED,size='+2'))
texte.append(coupe)
...
##################################################
# page des resultats
page_res=SimpleDocument('zp2024rc.html')
#ligne horizontale
page_res.append(HR())
...
##################################################
# page du classement
page_classement=SimpleDocument('zp2024rc.html')
#ligne horizontale
...
page_r1=SimpleDocument('zp2024rc.html')
#ligne horizontale
page_r1.append(HR())
# ancre de cette partie et ajout du lien
...
##################################################
# reglements
page_regle=SimpleDocument('zp2024rc.html')
#ligne horizontale
