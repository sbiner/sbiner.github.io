...
res_r2={'CAL/EDM':'EDM 5', 'FLO/TB':'TB 4', 'CAL/EDM':'EDM 5'}
res_r3={}
res_r4={}
...
page_choix=SimpleDocument('zp2022rc.html')
...
texte.append(coupe)
texte.append(Font('Ze Pool 2022',color=HTMLcolors.RED,size='+2'))
texte.append(coupe)
...
##################################################
# page des resultats
page_res=SimpleDocument('zp2022rc.html')
#ligne horizontale
page_res.append(HR())
...
##################################################
# page du classement
page_classement=SimpleDocument('zp2022rc.html')
#ligne horizontale
...
page_r1=SimpleDocument('zp2022rc.html')
#ligne horizontale
page_r1.append(HR())
# ancre de cette partie et ajout du lien
...
##################################################
# reglements
page_regle=SimpleDocument('zp2022rc.html')
#ligne horizontale
