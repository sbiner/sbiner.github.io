...
clefs_r1='nom TB/NJ BOS/TOR WAS/CLS PIT/PHI NAS/COL WIN/MIN LV/LA ANA/SJ '.split()
r1=[]
r1.append('Fred, NJ 4, TOR 4, CLS 4, PHI 4, COL 4, MIN 4, LA 4, SJ 4, LV'.split(','))
r1.append('Travis*, TB 6, BOS 7, CLS 6, PIT 6, NAS 5, WIN 6, LA 7, ANA 6, BOS'.split(','))
r1.append('Alain*, TB 6, BOS 7, WAS 5, PIT 5, NAS 4, WIN 6, LA 6, ANA 7, NAS'.split(','))
r1.append('Pat*, TB 6, BOS 6, WAS 6, PIT 7, NAS 5, WIN 5, LA 6, SJ 7, WIN'.split(','))
r1.append('Laurent, TB 5, BOS 6, WAS 7, PIT 6, NAS 4, WIN 5, LA 4, ANA 7, WIN'.split(','))
r1.append('Katherine*, TB 5, BOS 6, WAS 4, PIT 6, NAS 5, WIN 4, LA 6, ANA 6, TB'.split(','))
r1.append('Mederic*, TB 6, BOS 7, WAS 5, PIT 5, NAS 4, WIN 4, LA 6, SJ 7, PIT'.split(','))
r1.append('Emilie*, TB 5, BOS 6, WAS 4, PHI 4, COL 7, WIN 5, LV 6, SJ 4, BOS'.split(','))
r1.append('Chee*, TB 6, BOS 6, WAS 7, PIT 7, NAS 7, WIN 5, LA 5, SJ 6, WIN'.split(','))
r1.append('Chee Jr #1*, TB 4, BOS 7, WAS 5, PIT 6, NAS 4, WIN 5, LV 5, ANA 6, TB'.split(','))
r1.append('Chee Jr #2*, TB 5, BOS 6, WAS 6, PIT 6, NAS 5, WIN 6, LV 6, SJ 7, BOS'.split(','))
r1.append('Do*, TB 5, BOS 6, WAS 6, PIT 6, NAS 5, WIN 5, LV 7, SJ 7, TB'.split(','))
r1.append('Mike*, TB 5, TOR 6, CLS 7, PIT 6, NAS 4, WIN 5, LA 6, ANA 7, TB'.split(','))
r1.append('Valerie*, TB 6, TOR 7, WAS 5, PIT 6, NAS 5, WIN 7, LV 6, ANA 7, LV'.split(','))
r1.append('Phil R.*, TB 6, BOS 6, WAS 6, PIT 6, NAS 5, WIN 5, LA 6, ANA 6, NAS'.split(','))
r1.append('Seb*, TB 6, TOR 7, WAS 5, PIT 6, NAS 5, WIN 6, LV 7, ANA 6, NAS'.split(','))
r1.append('Norm*, TB 6, BOS 7, CLS 7, PIT 6, NAS 5, WIN 4, LA 7, SJ 7, PIT'.split(','))
r1.append('Phil P.*, TB 6, BOS 6, WAS 6, PIT 7, NAS 6, WIN 7, LA 6, ANA 6, BOS'.split(','))
r1.append('Simon, TB 5, TOR 6, WAS 4, PHI 7, NAS 4, WIN 7, LV 5, SJ 6, NAS'.split(','))
r1.append('Anne*, TB 6, BOS 7, WAS 6, PIT 7, NAS 5, WIN 7, LV 5, ANA 7, LV'.split(','))
r1.append('Daniel*, TB 6, BOS 7, WAS 6, PIT 6, NAS 5, WIN 7, LA 7, SJ 6, WIN'.split(','))
...
clefs_r2='nom TB/BOS WAS/PIT LV/SJ NAS/WIN'.split()
r2=[]
r2.append('Fred, BOS 4, PIT 4, SJ 4, WIN 4'.split(','))
r2.append('Travis*, BOS 6, PIT 6, LV 6, WIN 7'.split(','))
r2.append('Alain*, TB 7, PIT 6, LV 6, NAS 7'.split(','))
r2.append('Pat, TB 6, PIT 6, SJ 6, WIN 6'.split(','))
r2.append('Laurent, TB 6, WAS 7, SJ 7, NAS 6'.split(','))
r2.append('Katherine*, TB 5, PIT 6, LV 6, WIN 6'.split(','))
r2.append('Mederic*, BOS 6, PIT 5, SJ 6, WIN 7'.split(','))
r2.append('Emilie*, BOS 6, WAS 6, LV 5, WIN 4'.split(','))
r2.append('Chee*, BOS 6, PIT 7, LV 7, WIN 6'.split(','))
r2.append('Chee Jr #1*, TB 6, PIT 6, LV 7, NAS 7'.split(','))
r2.append('Chee Jr #2*, BOS 7, WAS 7, SJ 7, WIN 7'.split(','))
r2.append('Do*, TB 5, PIT 7, LV 6, WIN 6'.split(','))
r2.append('Mike*, TB 5, WAS 7, LV 7, WIN 6'.split(','))
r2.append('Valerie*, TB 6, WAS 7, LV 6, WIN 7'.split(','))
r2.append('Phil R., TB 6, PIT 6, LV 6, NAS 7'.split(','))
r2.append('Seb*, TB 6, WAS 7, LV 6, WIN 7'.split(','))
r2.append('Norm*, TB 6, PIT 7, LV 6, WIN 7'.split(','))
r2.append('Phil P.*, BOS 7, PIT 6, SJ 7, NAS 7'.split(','))
r2.append('Simon, TB 7, WAS 6, LV 6, NAS 5'.split(','))
r2.append('Anne*, TB 6, PIT 6, LV 7, NAS 6'.split(','))
r2.append('Daniel*, TB 6, PIT 6, LV 6, WIN 6'.split(','))

clefs_r3='nom TB/WAS WIN/LV'.split()
r3=[]
r3.append('Fred, WAS 4, WIN 5'.split(','))
r3.append('Travis*, TB 7, WIN 6'.split(','))
r3.append('Alain*, TB 7, LV 7'.split(','))
r3.append('Pat, WAS 6, WIN 6'.split(','))
r3.append('Laurent, WAS 7, WIN 6'.split(','))
r3.append('Katherine*, TB 6, WIN 6'.split(','))
r3.append('Mederic*, WAS 7, WIN 6'.split(','))
r3.append('Emilie*, TB 6, LV 5'.split(','))
r3.append('Chee*, WAS 6, WIN 5'.split(','))
r3.append('Chee Jr #1*, TB 7, WIN 7'.split(','))
r3.append('Chee Jr #2*, TB 7, WIN 7'.split(','))
r3.append('Do*, TB 6, WIN 7'.split(','))
r3.append('Mike*, TB 7, WIN 6'.split(','))
r3.append('Valerie*, WAS 7, LV 6'.split(','))
r3.append('Phil R., WAS 6, WIN 6'.split(','))
r3.append('Seb*, TB 6, WIN 6'.split(','))
r3.append('Norm*, TB 6, WIN 7'.split(','))
r3.append('Phil P.*, WAS 6, WIN 6'.split(','))
r3.append('Simon, TB 6, WIN 6'.split(','))
r3.append('Anne*, TB 6, LV 7'.split(','))
r3.append('Daniel*, TB 7, WIN 6'.split(','))

clefs_r4='nom LV/WAS'.split()
r4=[]
r4.append('Fred, LV 4'.split(','))
r4.append('Travis*, LV 4'.split(','))
r4.append('Alain*, LV 5'.split(','))
r4.append('Pat, WAS 6'.split(','))
r4.append('Laurent, WAS 7'.split(','))
r4.append('Katherine*, LV 5'.split(','))
r4.append('Mederic*, WAS 6'.split(','))
r4.append('Emilie*, LV 5 '.split(','))
r4.append('Chee*, WAS 5'.split(','))
r4.append('Chee Jr #1*, LV 6'.split(','))
r4.append('Chee Jr #2*, LV 7'.split(','))
r4.append('Do*, WAS 6'.split(','))
r4.append('Mike*, LV 7'.split(','))
r4.append('Valerie*, LV 6'.split(','))
r4.append('Phil R., LV 4'.split(','))
r4.append('Seb*, WAS 7'.split(','))
r4.append('Norm*, WAS 7'.split(','))
r4.append('Phil P.*, WAS 7'.split(','))
r4.append('Simon, LV 7'.split(','))
r4.append('Anne*, LV 7'.split(','))
r4.append('Daniel*, WAS 5'.split(','))

res_r1={'LV/LA': 'LV 4', 'NAS/COL':'NAS 6', 'WIN/MIN':'WIN 5', 'ANA/SJ':'SJ 4', 'TB/NJ':'TB 5',
        'WAS/CLS':'WAS 6', 'PIT/PHI': 'PIT 6', 'BOS/TOR':'BOS 7'}
res_r2={'TB/BOS' : 'TB 5', 'LV/SJ':'LV 6', 'WAS/PIT': 'WAS 6', 'NAS/WIN':'WIN 7'}
res_r3={'WIN/LV':'LV 5', 'TB/WAS':'WAS 7'}
res_r4={'LV/WAS':'WAS 5'}
...
page_choix=SimpleDocument('zp2018rc.html')
...
texte.append(coupe)
texte.append(Font('Ze Pool 2018',color=HTMLcolors.RED,size='+2'))
texte.append(coupe)
...
##################################################
# page des resultats
page_res=SimpleDocument('zp2018rc.html')
#ligne horizontale
page_res.append(HR())
...
##################################################
# page du classement
page_classement=SimpleDocument('zp2018rc.html')
#ligne horizontale
...
page_r1=SimpleDocument('zp2018rc.html')
#ligne horizontale
page_r1.append(HR())
# ancre de cette partie et ajout du lien
...
##################################################
# reglements
page_regle=SimpleDocument('zp2018rc.html')
#ligne horizontale
