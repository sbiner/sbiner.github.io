...
clefs_r1='nom  TB/CLS NYI/PIT WIN/STL NAS/DAL SJ/LV BOS/TOR WAS/CAR CAL/COL'.split()
r1=[]
r1.append('Fred, CLS 4, PIT 4, STL 4, DAL 4, LV 4, TOR 4, CAR 4, COL 4, COL'.split(','))
r1.append('Travis*, TB 6, PIT 6, WIN 6, NAS 5, LV 6, BOS 6, WAS 5, CAL 5, CAL'.split(','))
r1.append('Alain, TB 5, PIT 7, STL 7, NAS 7, LV 7, BOS 6, WAS 6, CAL 5, CAL'.split(','))
r1.append('Pat, TB 6, PIT 6, STL 6, DAL 6, SJ 7, BOS 6, WAS 5, CAL 5, STL  '.split(','))
r1.append('Do*, TB 6, NYI 6, WIN 6, NAS 6, SJ 6, BOS 6, WAS 6, CAL 6, WAS'.split(','))
r1.append('Mike*, TB 4, PIT 6, STL 6, NAS 5, LV 6, BOS 7, WAS 4, CAL 5, TB'.split(','))
r1.append('Valerie*, TB 5, PIT 6, WIN 5, NAS 4, SJ 7, TOR 6, CAR 6, CAL 5, NAS'.split(','))
r1.append('Phil R., TB 7, NYI 7, WIN 7, NAS 7, SJ 7, BOS 7, WAS 7, CAL 7, TB'.split(','))
r1.append('Phil P.*, TB 7, NYI 7, STL 6, NAS 6, LV 7, BOS 6, WAS 6, CAL 5, BOS'.split(','))
r1.append('Seb*, TB 5, PIT 6, WIN 6, NAS 6, SJ 5, TOR 7, WAS 5, CAL 6, TB'.split(','))
r1.append('Norm*, TB 4, PIT 7, STL 6, NAS 6, SJ 7, BOS 6, WAS 5, CAL 5, TB'.split(','))
r1.append('Anne*, TB 5, PIT 6, WIN 7, NAS 5, LV 6, BOS 7, WAS 6, CAL 5, TB'.split(','))
r1.append('Daniel*, TB 6, NYI 6, STL 6, NAS 7, LV 6, BOS 5, CAR 6, CAL 6, TB'.split(','))
r1.append('Chee*, TB 6, PIT 4, WIN 7, NAS 4, LV 6, BOS 5, WAS 5, CAL 5, BOS'.split(','))
r1.append('Chee JR1*, TB 6, NYI 7, STL 7, NAS 7, SJ 6, BOS 6, WAS 6, CAL 7, TB '.split(','))
r1.append('Chee JR2*, TB 4, PIT 7, WIN 7, NAS 4, SJ 5, BOS 6, WAS 5, CAL 4, TB'.split(','))
...
clefs_r2='nom BOS/CLS NYI/CAR STL/DAL SJ/COL'.split()
r2=[]
r2.append('Fred, CLS 6, NYI 6, STL 6, COL 6'.split(','))
r2.append('Travis, BOS 6, NYI 7, DAL 7,SJ 7'.split(','))
r2.append('Alain, BOS 6, NYI 6, STL 6, SJ 6'.split(','))
r2.append('Pat,   CLS 6, NYI 6, STL 6, SJ 7'.split(','))
r2.append('Do, BOS 6, NY 7, DAL 7, SJ 6'.split(','))
r2.append('Mike, CLS 6, NYI 5, DAL 6, COL 7'.split(','))
r2.append('Valerie, CLS 6, CAR 6, STL 5, SJ 5'.split(','))
r2.append('Phil R., BOS 7, NY 7, STL 7, SJ 7'.split(','))
r2.append('Phil P., BOS 7, CAR 7, DAL 7, SJ 7'.split(','))
r2.append('Seb*, BOS 6, NYI 5, STL 6, COL 6'.split(','))
r2.append('Norm, BOS 7, NYI 7, STL 6, COL 6'.split(','))
r2.append('Anne, CLS 6, NYI 6, STL 7, COL 7'.split(','))
r2.append('Daniel, CLS 6, CAR 6, STL 5, COL 6'.split(','))
r2.append('Chee, BOS 7, NYI 5, STL 5, SJ 6'.split(','))
r2.append('Chee JR1,  CLS 6, NYI 6, STL 7, SJ 6'.split(','))
r2.append('Chee JR2, BOS 7, NYI 7, DAL 6, SJ 6'.split(','))


clefs_r3='nom BOS/CAR SJ/STL'.split()
r3=[]
r3.append('Fred, CAR 4, STL 4'.split(','))
r3.append('Travis, BOS 6, SJ 7'.split(','))
r3.append('Alain, BOS 6, STL 6'.split(','))
r3.append('Pat, BOS 5, STL 6 '.split(','))
r3.append('Do, BOS 6, SJ 7'.split(','))
r3.append('Mike, BOS 7, STL 6'.split(','))
r3.append('Valerie, CAR 6, SJ 6'.split(','))
r3.append('Phil R., BOS 6, STL 6'.split(','))
r3.append('Phil P., BOS 7, SJ 7'.split(','))
r3.append('Seb*, CAR 4, STL 6'.split(','))
r3.append('Norm, BOS 7, STL 6'.split(','))
r3.append('Anne, BOS 5, SJ 6'.split(','))
r3.append('Daniel, CAR 6, STL 7'.split(','))
r3.append('Chee, BOS 5, STL 6'.split(','))
r3.append('Chee JR1, CAR 6, SJ 7 '.split(','))
r3.append('Chee JR2, BOS 6, SJ 7'.split(','))


clefs_r4='nom BOS/STL'.split()
r4=[]
r4.append('Fred, BOS 7 '.split(','))
r4.append('Travis, BOS 6'.split(','))
r4.append('Alain, STL 6'.split(','))
r4.append('Pat, STL 6'.split(','))
r4.append('Do, BOS 7'.split(','))
r4.append('Mike, STL 6'.split(','))
r4.append('Valerie, STL 6'.split(','))
r4.append('Phil R., BOS 6'.split(','))
r4.append('Phil P., BOS 6'.split(','))
r4.append('Seb*, STL 7'.split(','))
r4.append('Norm, STL 4'.split(','))
r4.append('Anne, BOS 6'.split(','))
r4.append('Daniel, STL 6'.split(','))
r4.append('Chee, BOS 6'.split(','))
r4.append('Chee JR1, BOS 6'.split(','))
r4.append('Chee JR2, BOS 7'.split(','))


res_r1={'TB/CLS':'CLS 4', 'NYI/PIT':'NYI 4',  'WIN/STL':'STL 6', 'CAL/COL':'COL 5', 'NAS/DAL':'DAL 6',
        'BOS/TOR':'BOS 7', 'SJ/LV':'SJ 7', 'WAS/CAR':'CAR 7'}
res_r2={'NYI/CAR':'CAR 4','BOS/CLS':'BOS 6','STL/DAL':'STL 7', 'SJ/COL':'SJ 7' }
res_r3={'BOS/CAR':'BOS 4', 'SJ/STL':'STL 6'}
res_r4={'BOS/STL':'STL 7'}
...
page_choix=SimpleDocument('zp2019rc.html')
...
texte.append(coupe)
texte.append(Font('Ze Pool 2019',color=HTMLcolors.RED,size='+2'))
texte.append(coupe)
...
##################################################
# page des resultats
page_res=SimpleDocument('zp2019rc.html')
#ligne horizontale
page_res.append(HR())
...
##################################################
# page du classement
page_classement=SimpleDocument('zp2019rc.html')
#ligne horizontale
...
page_r1=SimpleDocument('zp2019rc.html')
#ligne horizontale
page_r1.append(HR())
# ancre de cette partie et ajout du lien
...
##################################################
# reglements
page_regle=SimpleDocument('zp2019rc.html')
#ligne horizontale
